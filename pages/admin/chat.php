...
$jobsStmt = $pdo->prepare("
    ...
    GROUP BY j.id, j.reference_number, j.title, c.full_name, a.full_name
...
<section class="card">
    ...
    <p>Read-only view of client and artist conversations for your managed jobs.</p>
    ...
    <div class="chat-layout">
        <aside class="chat-job-list">
            ...
            <?php foreach ($jobs as $job): ?>
                <a class="chat-job-link <?= (int) $job['id'] === $selectedJobId ? 'active' : '' ?>" href="/smartprint-workflow/pages/admin/chat.php?job_id=<?= (int) $job['id'] ?>">
        ...
        <div class="chat-thread-wrap">
            ...
            <?php else: ?>
                <div class="chat-thread-head">
                    ...
                    <p><?= e($selectedJob['client_name']) ?> ↔ <?= e($selectedJob['artist_name']) ?></p>
                </div>
